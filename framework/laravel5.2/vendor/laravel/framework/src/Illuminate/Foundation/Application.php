...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
    ...
    protected function bindPathsInContainer()
    {
        ...
        foreach (['base', 'config', 'database', 'lang', 'public', 'storage','web'] as $path) {
    ...
    {
        return $this->webPath.DIRECTORY_SEPARATOR.'config';
    }
    ...
    {
        return $this->databasePath ?: $this->webPath.DIRECTORY_SEPARATOR.'database';
    }
    ...
    {
        return $this->webPath.DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'lang';
    }
    ...
    {
        return $this->storagePath ?: $this->webPath.DIRECTORY_SEPARATOR.'storage';
    }
