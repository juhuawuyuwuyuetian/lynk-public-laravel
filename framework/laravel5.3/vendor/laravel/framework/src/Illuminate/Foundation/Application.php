...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
     ...
     * @return void
     */
    public function __construct($webPath = null,$basePath=null)
    {
    ...
    {
        return $this->webPath.DIRECTORY_SEPARATOR.'app';
    }
    ...
    {
        return $this->webPath.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'config';
    }
    ...
    {
        return $this->databasePath ?: $this->webPath.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'database';
    }
    ...
    {
        return $this->webPath.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'lang';
    }
    ...
    {
        return $this->webPath.DIRECTORY_SEPARATOR.'public';
    }
    ...
    {
        return $this->storagePath ?: $this->webPath.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'storage';
    }
    ...
    public function getNamespace()
    {
        ...
        $composer = json_decode(file_get_contents(web_path('composer.json')), true);

        foreach ((array) data_get($composer, 'autoload.psr-4') as $namespace => $path) {
            foreach ((array) $path as $pathChoice) {
                if (realpath(app_path()) == realpath(web_path().'/'.$pathChoice)) {
